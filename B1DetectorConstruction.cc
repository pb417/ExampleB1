...
{  
  ...
  G4double Poly_thick = 0.2*m; //thickness Polyethylene
  G4double Cu_thick = 0.12*m;  //thickness Copper
  G4double tank2_thick = 0.25*m;
  G4double water_thick = 3*m;
  G4double tank1_thick = 0.5*m;
  ...
  G4double tank1_hz = Xe_rmax + Poly_thick + Cu_thick + tank2_thick + water_thick + tank1_thick;
  ...
  G4Material* GXe  =
    new G4Material("liquidArgon",z=54., a = 135.907227*g/mole, density = 0.00548536); //EDIT DENSITY XE136
